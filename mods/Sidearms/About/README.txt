...
[list]
[*][b]Carry spare weapons.[/b] Right-click a weapon on the ground with a pawn selected and pick "Carry {weapon} as sidearm". The pawn walks over, picks it up, and keeps it in their inventory.
...
[b]To melee (on by default).[/b] A hostile pawn coming within about 3 tiles counts as melee range. Your pawn draws the melee sidearm with the highest DPS they can use. Once no enemy is within 5 tiles, they put it away and go back to the weapon they were holding before. The gap between those two distances is deliberate: without it a pawn would flip weapons back and forth while an enemy dances along the edge of the threshold.
...
[b][url=https://steamcommunity.com/sharedfiles/filedetails/?id=3735900296]Manage Sidearm Policies[/url].[/b] Supported. Weapons a sidearm policy puts in a colonist's inventory get a command-bar button and are used by the auto-switch, same as ones you picked out by hand.
