...
{
    // Every weapon a pawn carries is a sidearm, with no list to manage and nothing to mark. Off by
    // default: turning it on hands every pawn a button for whatever they happen to be hauling.
    public bool allCarriedWeaponsAreSidearms;
    ...
    {
        base.ExposeData();
        Scribe_Values.Look(ref allCarriedWeaponsAreSidearms, "allCarriedWeaponsAreSidearms", defaultValue: false);
    ...
    public void DoWindowContents(Rect inRect)
    {
        ...
        list.CheckboxLabeled("Sidearms_Setting_AllCarried".Translate(), ref allCarriedWeaponsAreSidearms,
