# RimWorld 1.6 modding monorepo

One repo, many mods. Each folder under `mods/` is self-contained and syncs into the game's
`Mods/` directory on its own.
...
the toolchain works before blaming your own mod. See `docs/verified-facts.md`.
